...
#
verify value [expr int([numIter] <= 3)] 1 0

verify error [nodeDisp 10 1] -89.13531349065809  1e-6
verify error [nodeDisp 10 2] -54.69840418552875  1e-6
verify error [nodeDisp 10 6]   0.45719570852668  1e-6
