...
#   model.fix(ne+1, (0, 1, 1, 0, 1, 1))
    ...
    tol = 1e-16
    criteria = "Residual"
#   model.test("EnergyIncr", 1e-8, 500, 1)
    model.test(criteria,   tol, 20, 1)
...
#   model.test("RelativeNormDispIncr", 1e-6, 50, 1)
    ...
    model.integrator("MinUnbalDispNorm", 1, 5,  1/steps/100, 1)
