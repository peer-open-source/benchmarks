...
ops.section('ElasticFrame',1,E=E,A=A,Iy=I,Iz=I,G=12000,J=2*I, Ay=A*500,Az=A*500)
...
assert isclose(-m*L*L/(2*E*I), u23, rel_tol=1e-4), (-m*L*L/(2*E*I), u23)
assert isclose(-m*L*L*L/(3*E*I), u22, rel_tol=1e-4), (-m*L*L*L/(3*E*I), u22)
