...
# SmallEigen.tcl: Small 3 dof 2 spring model: checking eigen results of smallest and largest values
# using masses defined through node and mass command, results compared for exact against Matlab
