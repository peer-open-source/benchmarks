...
def create_cantilever(shape,
    ...
    model = xara.Model(ndm=3, ndf=6)#, echo_file=open(f"dbg-{element}-{section}-{transform}.tcl","w+"))
...
def analyze(model):
    ...
    model.test("NormUnbalance", 1e-8, 50, 0) #50 #20
...
if __name__ == "__main__":
    ...
    # fig.savefig("img/frame-1002.png")
    plt.show()
