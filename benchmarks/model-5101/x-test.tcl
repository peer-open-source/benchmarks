...
set ok [analyze $numSteps $deltaT [expr $deltaT/100] $deltaT 10]
# Check that analysis succeeded
verify value $ok 0


# Check that dispalcements match OpenSees results
verify error [nodeDisp 3 1]  0.00001795294117647015 1e-10
verify error [nodeDisp 3 2] -0.00003740196078431957 1e-10