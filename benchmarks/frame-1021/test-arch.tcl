foreach Frame {PrismFrame ForceFrame} {
  ...
  element $Frame  1  1  2 -section 1 -transform 1 -shear 1
  element $Frame  2  2  3 -section 1 -transform 1 -shear 1
  element $Frame  3  3  4 -section 1 -transform 1 -shear 1
  element $Frame  4  4  5 -section 1 -transform 1 -shear 1
  element $Frame  5  5  6 -section 1 -transform 1 -shear 1
  element $Frame  6  6  7 -section 1 -transform 1 -shear 1
  element $Frame  7  7  8 -section 1 -transform 1 -shear 1
  element $Frame  8  8  9 -section 1 -transform 1 -shear 1
  element $Frame  9  9 10 -section 1 -transform 1 -shear 1
  element $Frame 10 10 11 -section 1 -transform 1 -shear 1
